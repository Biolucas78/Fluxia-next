...
// Criar diretório da rota
const routeDir = fs.existsSync('app/api') ? 'app/api/migrar-banco' :
  path.join(process.env.HOME || '', 'Fluxia-next/app/api/migrar-banco');
...
console.log('OK: Rota /api/migrar-banco criada em', routeDir);